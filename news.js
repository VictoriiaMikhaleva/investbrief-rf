/* news.js */
  ...
  var DEMO_BRIEFS = [
    ...
    { id: 'b12', ticker: 'NVTK', type: 'stock', publishedAt: hoursAgo(1), eventType: 'rating', tone: 'positive', importance: 'high',
      title: 'Новатэк: оценка инвестдомов: позитивный взгляд, спорят о размере выплаты',
      summary: 'После отчётности большинство домов оставили позитивный взгляд. В фокусе — LNG-проекты, валютная выручка и итоговый дивиденд на акцию.',
